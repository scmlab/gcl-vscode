...
var decode$3 = Util$Guacamole.Decode.sum((function (tag) {
        switch (tag) {
          ...
          case "Reduce" :
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                            return Json_decode.map((function (param) {
                                          return /* Reduce */Caml_chrome_debugger.variant("Reduce", 2, [
                                                    param[0],
                                                    param[1]
                                                  ]);
                                        }), (function (param) {
                                          return Json_decode.pair(GCL$Guacamole.Syntax.Expr.decode, GCL$Guacamole.Syntax.Expr.decodeSubst, param);
                                        }), param);
                          })]);
          case "SetMode" :
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (json) {
      ...
      case /* Reduce */2 :
          return Json_encode.object_(/* :: */Caml_chrome_debugger.simpleVariant("::", [
                        ...
                        /* :: */Caml_chrome_debugger.simpleVariant("::", [
                            /* tuple */[
                              "contents",
                              Json_encode.pair(GCL$Guacamole.Syntax.Expr.encode, GCL$Guacamole.Syntax.Expr.encodeSubst, /* tuple */[
                                    param[0],
                                    param[1]
                                  ])
                            ],
