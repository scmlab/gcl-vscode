...
function classify(param) {
  if (typeof param === "string") {
    ...
    return /* ThemeColor */Caml_chrome_debugger.variant("ThemeColor", 1, [param]);
  }
}
...
function classify$1(param) {
  if (typeof param === "string") {
    return /* String */Caml_chrome_debugger.variant("String", 0, [param]);
  } else {
    return /* Uri */Caml_chrome_debugger.variant("Uri", 1, [param]);
  }
}
...
function reveal(self, viewColumn, preserveFocus, param) {
  ...
  if (viewColumn$1 !== undefined) {
    var viewColumn$2 = viewColumn$1;
    if (preserveFocus !== undefined) {
      self.reveal(viewColumn$2, preserveFocus);
      return /* () */0;
    } else {
      self.reveal(viewColumn$2, undefined);
      return /* () */0;
    }
