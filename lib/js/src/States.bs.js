...
function Impl$1(Editor, State) {
  ...
  var partial_arg$1 = TaskRunner$Guacamole.Impl;
  var TaskRunner = (function (param) {
  ...
  var activate = function (context) {
    ...
    return Belt_Array.forEach(Command$Guacamole.names, (function (param) {
                  ...
                  return Curry._2(Editor.addToSubscriptions, Curry._2(Editor.registerCommand, param[1], (function (editor) {
                                    return Belt_Option.forEach(Curry._1(getByEditor, editor), (function (state) {
...
exports.isGCL = isGCL;
exports.Impl = Impl$1;
/* TaskRunner-Guacamole Not a pure module */
