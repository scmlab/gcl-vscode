  ...
  var activate = function (context) {
    ...
    Curry._2(Editor.addToSubscriptions, Curry._2(Editor.registerCommand, "toggle", (function (editor) {
                return Belt_Option.forEach(Curry._1(Editor.getFileName, editor), (function (fileName) {
                              ...
                              if (match !== undefined) {
                                Curry._2(TaskRunner$1.addTask, match[1], /* DispatchCommand */Caml_chrome_debugger.variant("DispatchCommand", 1, [/* Quit */1]));
                                ...
                                Curry._2(Editor.addToSubscriptions, Curry._2(Editor.View.recv, state.view, (function (response) {
                                            return Curry._2(TaskRunner$1.addTask, taskRunner, /* ViewResponse */Caml_chrome_debugger.variant("ViewResponse", 5, [response]));
                                          })), context);
                                return Curry._2(TaskRunner$1.addTask, taskRunner, /* DispatchCommand */Caml_chrome_debugger.variant("DispatchCommand", 1, [/* Load */0]));
                              }
                            }));
              })), context);
