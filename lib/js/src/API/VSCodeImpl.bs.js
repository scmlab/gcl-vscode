...
var API$Guacamole = require("../API.bs.js");
...
function registerCommand(name, callback) {
  return Vscode.commands.registerCommand("guacamole." + name, (function (param) {
                return Belt_Option.flatMap(Vscode.window.activeTextEditor, (function (editor) {
                              ...
                              return Belt_Option.map($$document.fileName, (function (fileName) {
...
var View = {
  send: ViewController$Guacamole.send,
  recv: ViewController$Guacamole.recv,
  destroy: ViewController$Guacamole.destroy,
  show: ViewController$Guacamole.show,
  focus: ViewController$Guacamole.focus,
  hide: ViewController$Guacamole.hide,
  make: ViewController$Guacamole.make
};
...
var destroy = Editor$Guacamole.Decoration.destroy;
...
function toUTF8Offset($$document, offset) {
  ...
  return API$Guacamole.characterWidth($$document.getText(Caml_option.some(range)));
}
...
function registerTestingProvider(prodider, legend) {
  ...
  var documentSemanticTokensProvider = {
    provideDocumentSemanticTokens: (function (textDocument, param) {
        return VSCode.ProviderResult.map(Curry._1(prodider, textDocument.fileName), (function (prim) {
