...
function toString(param) {
  switch (param.tag | 0) {
    case /* PathSearch */0 :
        return Curry._1(Process2$Guacamole.PathSearch.$$Error.toString, param[0]);
    case /* Validation */1 :
        return Curry._1(Process2$Guacamole.Validation.$$Error.toString, param[0]);
    case /* Process */2 :
        return Process2$Guacamole.$$Error.toString(param[0]);
