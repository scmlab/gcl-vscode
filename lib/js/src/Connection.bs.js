...
var Process2$Guacamole = require("./Process2.bs.js");
var Caml_chrome_debugger = require("bs-platform/lib/js/caml_chrome_debugger.js");

function toString(e) {
  switch (e.tag | 0) {
    case /* PathSearch */0 :
        return Curry._1(Process2$Guacamole.PathSearch.$$Error.toString, e[0]);
    case /* Validation */1 :
        return Curry._1(Process2$Guacamole.Validation.$$Error.toString, e[0]);
    case /* Process */2 :
        return Process2$Guacamole.$$Error.toString(e[0]);
...
function getGCLPath(fromConfig) {
  ...
  if (storedPath === "" || storedPath === ".") {
    return $$Promise.mapError($$Promise.mapOk(Process2$Guacamole.PathSearch.run("gcl"), (function (prim) {
                      return prim.trim();
                    })), (function (e) {
...
function validateGCLPath(path) {
  return $$Promise.mapError(Process2$Guacamole.Validation.run(path + " --help", (function (output) {
                    if (/^GCL/.test(output)) {
                      return /* Ok */Caml_chrome_debugger.variant("Ok", 0, [path]);
                    } else {
...
function make(fromConfig, toConfig) {
  return $$Promise.tapOk($$Promise.mapOk($$Promise.flatMapOk($$Promise.flatMapOk(getGCLPath(fromConfig), validateGCLPath), (function (param) {
                    ...
                    var $$process = Process2$Guacamole.make(path, []);
                    return {
                            path: path,
                            process: $$process,
                            emitter: Event$Guacamole.make(undefined)
                          };
                  })), wire);
}
