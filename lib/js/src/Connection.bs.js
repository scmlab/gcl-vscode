...
function probe$1(param) {
  return $$Promise.flatMapError(probe(3000), (function (param) {
                var name = "gcl";
...
function start(param) {
  ...
  return $$Promise.map($$Promise.flatMapOk(probe$1(undefined), Connection__Client$Guacamole.make), (function (result) {
                if (result.TAG === /* Ok */0) {
...
function sendRequest(request) {
  var client = singleton.contents;
  if (typeof client === "number") {
    return $$Promise.flatMapOk(start(undefined), (function (param) {
