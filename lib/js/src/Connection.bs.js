...
var Connection__Client$Guacamole = require("./Connection/Connection__Client.bs.js");
var Connection__Prebuilt$Guacamole = require("./Connection/Connection__Prebuilt.bs.js");
...
function probe$1(globalStoragePath) {
  return $$Promise.flatMapError($$Promise.flatMapError(probe(3000), (function (param) {
                    return $$Promise.mapError($$Promise.mapOk(Connection__Prebuilt$Guacamole.get(globalStoragePath), (function (path) {
                                      return {
                                              TAG: 2,
...
function start(globalStoragePath) {
  ...
  if (typeof client !== "number") {
    if (client.TAG === /* Connecting */0) {
      ...
      return $$Promise.resolved({
                  TAG: 0,
                  _0: Connection__Client$Guacamole.getMethod(client._0),
                  [Symbol.for("name")]: "Ok"
                });
    }
  }
  ...
  return $$Promise.map($$Promise.flatMapOk(probe$1(globalStoragePath), Connection__Client$Guacamole.make), (function (result) {
                if (result.TAG === /* Ok */0) {
                  ...
                  Belt_Array.forEach(getPendingRequests(undefined), (function (param) {
                          return $$Promise.get($$Promise.flatMapOk(Connection__Client$Guacamole.sendRequest(client, Request$Guacamole.encode(param[0])), (function (json) {
                                            return $$Promise.resolved(decodeResponse(json));
                                          })), param[1]);
                        }));
                  Curry._1(resolve, {
                        TAG: 0,
                        _0: Connection__Client$Guacamole.getMethod(client),
                        [Symbol.for("name")]: "Ok"
                      });
...
function stop(param) {
  ...
  return Connection__Client$Guacamole.destroy(client._0);
}
...
function sendRequest(globalStoragePath, request) {
  ...
  if (client.TAG !== /* Connecting */0) {
    return $$Promise.flatMapOk(Connection__Client$Guacamole.sendRequest(client._0, Request$Guacamole.encode(request)), (function (json) {
                  return $$Promise.resolved(decodeResponse(json));
                }));
  }
  var match = $$Promise.pending(undefined);
...
function onResponse(handler) {
  return Connection__Client$Guacamole.onResponse(function (json) {
...
var Module = {
  ...
  onError: Connection__Client$Guacamole.onError
};
...
var onError = Connection__Client$Guacamole.onError;
