...
function afterDownload(fromCached, param) {
  ...
  Vscode.workspace.getConfiguration(undefined, undefined).update("guabao.gclPath", executablePath, 1, undefined);
  if (fromCached) {
...
function probe(globalStoragePath, onDownload) {
  var name = Belt_Option.mapWithDefault(Vscode.workspace.getConfiguration(undefined, undefined).get("guabao.gclPath"), "", (function (x) {
          return x;
        }));
