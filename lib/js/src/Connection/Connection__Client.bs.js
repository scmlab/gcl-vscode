...
function make(method) {
  var serverOptions;
  serverOptions = method.TAG === /* ViaStdIO */0 ? Connection__LSP$Guacamole.ServerOptions.makeWithCommand(method._0) : Connection__LSP$Guacamole.ServerOptions.makeWithStreamInfo(method._0);
