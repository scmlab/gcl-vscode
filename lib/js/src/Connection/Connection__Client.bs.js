...
function make(method) {
  ...
  switch (method.TAG | 0) {
    case /* ViaStdIO */0 :
        serverOptions = LSP$LanguageServerMule.ServerOptions.makeWithCommand(method._0);
        break;
    case /* ViaTCP */1 :
        serverOptions = LSP$LanguageServerMule.ServerOptions.makeWithStreamInfo(method._0, "localhost");
        break;
    case /* ViaPrebuilt */2 :
        serverOptions = LSP$LanguageServerMule.ServerOptions.makeWithCommand(method._1);
        break;
