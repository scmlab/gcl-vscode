...
var Connection__LSP$Guabao = require("./Connection__LSP.bs.js");
...
function make(method) {
  ...
  switch (method.TAG | 0) {
    case /* ViaStdIO */0 :
        serverOptions = Connection__LSP$Guabao.ServerOptions.makeWithCommand(method._0);
        break;
    case /* ViaTCP */1 :
        serverOptions = Connection__LSP$Guabao.ServerOptions.makeWithStreamInfo(method._0);
        break;
    case /* ViaPrebuilt */2 :
        serverOptions = Connection__LSP$Guabao.ServerOptions.makeWithCommand(method._1);
        break;
  ...
  var errorHandler = Connection__LSP$Guabao.ErrorHandler.make((function (exn, _msg, _count) {
          Chan$Guabao.emit(errorChan, exn);
          return /* Shutdown */1;
        }), (function (param) {
          return /* DoNotRestart */0;
        }));
  var clientOptions = Connection__LSP$Guabao.LanguageClientOptions.make(documentSelector, synchronize, errorHandler);
