      ...
      case /* Reload */2 :
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    /* WithState */Caml_chrome_debugger.variant("WithState", 0, [(function (state) {
                            var doc = Curry._1(Editor.getDocument, Curry._1(Task__Types.State.getEditor, state));
                            return Belt_Option.mapWithDefault(Curry._1(Editor.getFileName, doc), $$Promise.resolved(/* [] */0), (function (fileName) {
                                          return $$Promise.map(Curry._1(Editor.save, doc), (function (saveSucceed) {
                    ...
                    /* :: */Caml_chrome_debugger.simpleVariant("::", [
                        /* WithState */Caml_chrome_debugger.variant("WithState", 0, [(function (state) {
                                return Belt_Option.mapWithDefault(Curry._1(Task__Types.State.Spec.fromCursorPosition, state), $$Promise.resolved(/* [] */0), (function (spec) {
                                              ...
                                              var payload = Curry._2(Task__Types.State.Spec.getPayload, doc, spec);
          ...
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    ...
                    /* :: */Caml_chrome_debugger.simpleVariant("::", [
                        /* WithState */Caml_chrome_debugger.variant("WithState", 0, [(function (state) {
                                ...
                                var match = Curry._2(GCLImpl.Pos.fromPoint, cursor, "whatever");
                                return $$Promise.resolved(/* :: */Caml_chrome_debugger.simpleVariant("::", [
