                        ...
                        return Belt_Option.mapWithDefault(Curry._1(Editor.getFileName, editor), $$Promise.resolved(/* [] */0), (function (fileName) {
                                      return $$Promise.map(Curry._1(Editor.save, editor), (function (saveSucceed) {
                                                    if (saveSucceed && fileName !== "") {
                                                      ...
                                                      if (match) {
                                                        return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                                                  /* SendRequest */Caml_chrome_debugger.variant("SendRequest", 4, [/* Load2 */Caml_chrome_debugger.variant("Load2", 1, [fileName])]),
                                                                  /* [] */0
                                                                ]);
                                                      } else {
                                                        return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                                                  /* SendRequest */Caml_chrome_debugger.variant("SendRequest", 4, [/* Load */Caml_chrome_debugger.variant("Load", 0, [fileName])]),
                                                                  /* [] */0
                                                                ]);
                                                      }
                                                    } else {
