...
function Impl(Editor) {
  ...
  var handle = function (id, site, param) {
    switch (param) {
  ...
  var handle$1 = function (id, site, param) {
    switch (param) {
  ...
  var handle$2 = function (id, error) {
    var kind = error[1];
    var site = error[0];
    if (typeof kind === "number") {
      ...
      switch (kind.tag | 0) {
        ...
        case /* StructError */1 :
            return handle(id, site, kind[0]);
        case /* StructError2 */2 :
            return handle$1(id, site, kind[0]);
        case /* TypeError */3 :
            var match = kind[0];
            switch (match.tag | 0) {
              case /* NotInScope */0 :
