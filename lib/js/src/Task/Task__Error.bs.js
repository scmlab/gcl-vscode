      ...
      case /* DigHole */4 :
          ...
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    /* WithState */Caml_chrome_debugger.variant("WithState", 0, [(function (state) {
                            var range = Curry._3(GCL$Guacamole.$$Response.$$Error.Site.toRange, site, state.specifications, Editor.toRange);
                            return $$Promise.map(Curry._2(Editor.digHole, state.editor, range), (function (param) {
                                          return /* [] */0;
                                        }));
                          })]),
                    /* [] */0
