...
function Impl(Editor) {
  ...
  var handle = function (site, param) {
    switch (param) {
      case /* MissingAssertion */0 :
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    /* MarkError */Caml_chrome_debugger.variant("MarkError", 6, [site]),
      ...
      case /* DigHole */4 :
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    /* DigHole */Caml_chrome_debugger.variant("DigHole", 8, [site]),
                    /* :: */Caml_chrome_debugger.simpleVariant("::", [
  ...
  var handle$1 = function (site, param) {
    switch (param) {
        ...
        return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                  ...
                  /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* Display */Caml_chrome_debugger.variant("Display", 3, [
                          ...
                          /* Plain */Caml_chrome_debugger.variant("Plain", 1, [Curry._1(Response$Guacamole.$$Error.Site.toString, site)])
                        ]),
                      /* [] */0
                    ])
                ]);
    ...
    switch (kind.tag | 0) {
                ...
                return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                          ...
                          /* :: */Caml_chrome_debugger.simpleVariant("::", [
                              /* Display */Caml_chrome_debugger.variant("Display", 3, [
                                  ...
                                  /* Plain */Caml_chrome_debugger.variant("Plain", 1, ["The definition " + (name[0] + " is not in scope")])
                                ]),
                              /* [] */0
                            ])
                        ]);
            case /* UnifyFailed */1 :
                return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                          ...
                          /* :: */Caml_chrome_debugger.simpleVariant("::", [
                              /* Display */Caml_chrome_debugger.variant("Display", 3, [
                                  /* Error */Caml_chrome_debugger.variant("Error", 1, ["Type Error"]),
                                  /* Plain */Caml_chrome_debugger.variant("Plain", 1, ["Cannot unify: " + (Curry._1(GCL$Guacamole.Syntax.Type.toString, name[0]) + ("\nwith        : " + Curry._1(GCL$Guacamole.Syntax.Type.toString, name[1])))])
                                ]),
                              /* [] */0
                            ])
                        ]);
            case /* RecursiveType */2 :
                return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                          ...
                          /* :: */Caml_chrome_debugger.simpleVariant("::", [
                              /* Display */Caml_chrome_debugger.variant("Display", 3, [
                                  /* Error */Caml_chrome_debugger.variant("Error", 1, ["Type Error"]),
                                  /* Plain */Caml_chrome_debugger.variant("Plain", 1, ["Recursive type variable: " + (Curry._1(GCL$Guacamole.Syntax.Type.toString, /* Var */Caml_chrome_debugger.variant("Var", 3, [name[0]])) + ("\nin type             : " + Curry._1(GCL$Guacamole.Syntax.Type.toString, name[1])))])
                                ]),
                              /* [] */0
                            ])
                        ]);
            case /* NotFunction */3 :
                return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                          ...
                          /* :: */Caml_chrome_debugger.simpleVariant("::", [
                              /* Display */Caml_chrome_debugger.variant("Display", 3, [
                                  /* Error */Caml_chrome_debugger.variant("Error", 1, ["Type Error"]),
                                  /* Plain */Caml_chrome_debugger.variant("Plain", 1, ["The type " + (Curry._1(GCL$Guacamole.Syntax.Type.toString, name[0]) + " is not a function type")])
                                ]),
                              /* [] */0
                            ])
                        ]);
      ...
      case /* CannotDecodeRequest */4 :
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    ...
                    /* :: */Caml_chrome_debugger.simpleVariant("::", [
                        /* Display */Caml_chrome_debugger.variant("Display", 3, [
                            /* Error */Caml_chrome_debugger.variant("Error", 1, ["Cannot Decode Request"]),
