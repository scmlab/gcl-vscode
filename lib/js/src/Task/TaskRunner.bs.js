        ...
        switch (task.tag | 0) {
          ...
          case /* MarkSpec */2 :
              ...
              var decorations$1 = Belt_Array.concatMany([
                    Curry._4(Editor.Decoration.overlayText, state.editor, /* Spec */1, isQQ ? "" : preCondText, startRange),
                    Curry._4(Editor.Decoration.overlayText, state.editor, /* Spec */1, isQQ ? "" : postCondText, endRange),
                    Curry._3(Editor.Decoration.highlightBackground, state.editor, /* Spec */1, startRange),
                    Curry._3(Editor.Decoration.highlightBackground, state.editor, /* Spec */1, endRange)
                  ]);
              state.decorations = state.decorations.concat(decorations$1);
              return $$Promise.resolved(/* () */0);
          case /* DigHole */3 :
              var range$2 = Curry._3(GCL$Guacamole.$$Response.$$Error.Site.toRange, task[0], state.specifications, Editor.$$Range.fromLoc);
