      ...
      if (typeof task === "number") {
        ...
        switch (task.tag | 0) {
          ...
          case /* MarkError */1 :
              ...
              return $$Promise.resolved(/* () */0);
          case /* MarkSpec */2 :
              var range$1 = Curry._1(Editor.$$Range.fromLoc, task[0].loc);
              ...
              var decorations$1 = Belt_Array.concatMany([
                    Curry._3(Editor.Decoration.markBackground, state.editor, /* Spec */1, startRange),
                    Curry._3(Editor.Decoration.markBackground, state.editor, /* Spec */1, endRange)
                  ]);
