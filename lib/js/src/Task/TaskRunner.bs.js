      ...
      if (typeof task === "number") {
        ...
        switch (task.tag | 0) {
          ...
          case /* SetSpecifications */1 :
              Curry._2(State.setSpecifications, state, task[0]);
              return $$Promise.resolved(/* () */0);
          case /* AddDecorations */2 :
              return $$Promise.resolved(/* () */0);
          case /* MarkError */3 :
              var range = Curry._3(GCL$Guacamole.$$Response.$$Error.Site.toRange, task[0], state.specifications, Editor.toRange);
              state.decorations.push(Curry._2(Editor.Decoration.markBackground, state.editor, range));
              return $$Promise.resolved(/* () */0);
          case /* DigHole */4 :
              var range$1 = Curry._3(GCL$Guacamole.$$Response.$$Error.Site.toRange, task[0], state.specifications, Editor.toRange);
              ...
              return $$Promise.flatMap(Curry._2(State.sendRequest, state, task[0]), (function (param) {
                            if (param.tag) {
                              ...
                              return run(state, /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                            /* Display */Caml_chrome_debugger.variant("Display", 7, [
