        ...
        case /* SendRequest */2 :
            ...
            return $$Promise.map(Curry._2(State.sendRequest, state, task[0]), (function (param) {
                          if (param.tag) {
                            ...
                            var match$1 = param[0];
                            return Curry._2(TaskResponse.handle, match$1[0], match$1[1]);
                          }
                        }));
        case /* Display */3 :
            return $$Promise.map(Curry._4(State.display, state, task[0], task[1], task[2]), (function (param) {
                          return /* [] */0;
                        }));
        case /* ViewRequest */4 :
            return $$Promise.map(Curry._3(State.sendRequestToView, state, task[0], task[1]), (function (param) {
                          return /* [] */0;
                        }));
        case /* ViewResponse */5 :
