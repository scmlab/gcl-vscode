...
function Impl(Editor) {
  ...
  var handle = function (id, response) {
    switch (response.tag | 0) {
      case /* Error */0 :
          return Js_list.flatten(Belt_List.fromArray(Belt_Array.map(response[0], Curry._1(Task__Error.handle, id))));
      case /* OK */1 :
      ...
      case /* Substitute */3 :
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    /* ViewRequest */Caml_chrome_debugger.variant("ViewRequest", 4, [
                        id,
                        /* Substitute */Caml_chrome_debugger.variant("Substitute", 0, [
                            response[0],
                            response[1]
                          ])
                      ]),
