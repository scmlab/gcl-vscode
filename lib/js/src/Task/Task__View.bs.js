...
function Impl(Editor) {
  ...
  var clearDict = function (param) {
    return Belt_Array.forEach(Js_dict.entries(decorationDict), (function (param) {
                  delete_(param[0]);
                  return Belt_Array.forEach(param[1], Editor.Decoration.destroy);
                }));
  };
      ...
      case /* Link */1 :
          ...
          switch (loc.tag | 0) {
            case /* MouseOver */0 :
                ...
                var range = Curry._1(GCLImpl.Loc.toRange, loc$1);
                var decoration = Curry._3(Editor.Decoration.highlightBackground, editor, "editor.symbolHighlightBackground", [range]);
            ...
            case /* MouseOut */1 :
                ...
                return /* [] */0;
            case /* MouseClick */2 :
                var range$1 = Curry._1(GCLImpl.Loc.toRange, loc[0]);
