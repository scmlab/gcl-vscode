...
var Download$Guacamole = require("./Download.bs.js");
...
function activate(context) {
  ...
  $$Promise.flatMapOk(Download$Guacamole.getMatchingReleaseAndAsset(undefined), (function (param) {
          return Download$Guacamole.downloadLanguageServer(context, param);
        }));
