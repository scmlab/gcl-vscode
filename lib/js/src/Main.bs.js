...
function start(param) {
  if (Belt_Option.isNone(subscription.contents)) {
    subscription.contents = Caml_option.some(client.contents.start());
    return ;
  }
...
function stop(param) {
  var subscription$prime = subscription.contents;
  if (subscription$prime === undefined) {
    return $$Promise.resolved(undefined);
  }
  var subscription$prime$1 = Caml_option.valFromOption(subscription$prime);
  return $$Promise.tap(client.contents.stop(), (function (param) {
                subscription.contents = undefined;
