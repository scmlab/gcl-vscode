...
function activate(context) {
  ...
  subscribe(onOpenEditor(function (editor) {
            ...
            if (state !== undefined) {
              ...
              var state$2 = State$Guacamole.make(devMode, globalStoragePath, editor);
  ...
  subscribe(onActivateExtension(function (param) {
            ...
            return $$Promise.get(Connection$Guacamole.make(devMode, globalStoragePath), (function (result) {
                          if (result.TAG === /* Ok */0) {
