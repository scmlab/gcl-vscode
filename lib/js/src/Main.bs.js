                ...
                if (typeof response === "number") {
                  switch (response) {
                    case /* ExportProofObligations */0 :
                        console.log("viewOnResponse.ExportProofObligations");
                        $$Promise.flatMap(Curry._1(state.lspSendRequest, {
                                  _0: state.filePath,
                                  _1: /* ExportProofObligations */1,
                                  [Symbol.for("name")]: "Req"
                                }), (function (param) {
...
function activate(context) {
  ...
  subscribe(onOpenEditor(function (editor) {
            ...
            if (state !== undefined) {
              ...
              var state$2 = State$Guacamole.make(editor, View$Guacamole.send, send);
              Registry$Guacamole.add(filePath, state$2);
              state$1 = state$2;
            }
            return $$Promise.get(send({
                            _0: state$1.filePath,
                            _1: /* Load */0,
                            [Symbol.for("name")]: "Req"
                          }), handleResponse);
