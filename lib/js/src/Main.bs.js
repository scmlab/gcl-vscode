...
function activate(context) {
  ...
  var serverOptions = /* RunNodeModule */Caml_chrome_debugger.variant("RunNodeModule", 2, [{
        module: serverPath,
        transport: /* IPC */1,
        args: [],
        runtime: undefined,
  ...
  var client = new VscodeLanguageclient.LanguageClient("id", "name", serverOptions, clientOptions);
  client.start();
