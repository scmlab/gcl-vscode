...
function handleViewResponse(context, response) {
...
function activate(context) {
  ...
  subscribe(LSP$Guacamole.Client.onError(function (exn) {
            ...
            var shouldSwitchToSTDIO = devMode && isECONNREFUSED;
            if (shouldSwitchToSTDIO) {
              LSP$Guacamole.Client.start(devMode, false);
            } else {
  ...
  subscribe(onActivateExtension(function (param) {
            ...
            return $$Promise.get(View$Guacamole.activate(extensionPath, devMode), (function (_viewActivationResult) {
                          LSP$Guacamole.Client.start(devMode, devMode);
  ...
  subscribe(View$Guacamole.on(function (param) {
            return handleViewResponse(context, param);
          }));
