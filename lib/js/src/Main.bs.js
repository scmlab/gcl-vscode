  ...
  return Belt_Option.forEach(previouslyActivatedState.contents, (function (state) {
                ...
                switch (loc.TAG | 0) {
                  case /* MouseOver */0 :
                      ...
                      var range = GCL$Guacamole.Loc.toVSCodeRange(loc$1);
                  ...
                  case /* MouseClick */2 :
                      ...
                      var range$1 = GCL$Guacamole.Loc.toVSCodeRange(loc$2);
            ...
            if (shouldTrigger) {
              return Belt_Option.forEach(Registry$Guacamole.get(filePath), (function (state) {
                            return Belt_Option.forEach(Belt_Array.get(selections, 0), (function (selection) {
                                          var start = GCL$Guacamole.Pos.fromVSCodePos(selection.start, state.document);
                                          var end = GCL$Guacamole.Pos.fromVSCodePos(selection.end, state.document);
