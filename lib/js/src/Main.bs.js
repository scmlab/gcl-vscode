...
function handleViewResponse(response) {
  return Belt_Option.forEach(previouslyActivatedState.contents, (function (state) {
                ...
                switch (range.TAG | 0) {
                  ...
                  case /* MouseOut */1 :
                      var key$1 = SrcLoc$Guacamole.$$Range.toString(range._0);
                      console.log("out " + key$1);
                      return State$Guacamole.Decoration.remove(key$1);
                  case /* MouseClick */2 :
                      var range$3 = range._0;
                      var key$2 = SrcLoc$Guacamole.$$Range.toString(range$3);
                      State$Guacamole.Decoration.remove(key$2);
