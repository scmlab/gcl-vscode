...
function sendRequest(request) {
  return $$Promise.map($$Promise.flatMapOk($$Promise.Js.toResult(client.contents.onReady()), (function (param) {
                ...
                if (json.TAG) {
                  return {
                          TAG: 3,
                          _0: Response$Guacamole.$$Error.fromJsError(json._0),
                          [Symbol.for("name")]: "CannotSendRequest"
                        };
                } else {
                  return decodeResponse(json._0);
                }
              }));
}
...
function onOpenEditor(context, editor) {
  ...
  $$Promise.get($$Promise.tap(sendRequest({
                _0: state$1.filePath,
                _1: /* Load */0,
                [Symbol.for("name")]: "Req"
              }), (function (param) {
