...
var Client$Guacamole = require("./Client.bs.js");
...
function activate(context) {
  ...
  disposables.push(registerCommand("toggle", (function (editor, fileName) {
              ...
              if (match !== undefined) {
                TaskRunner$Guacamole.addTask(match[1], {
                      TAG: 1,
                      _0: /* Quit */1,
              ...
              var client = Client$Guacamole.make(fileName);
              var state = State$Guacamole.make(extensionPath, editor, client);
              ...
              Registry$Guacamole.add(fileName, [
                    state,
                    taskRunner
                  ]);
              disposables.push(View$Guacamole.recv(state.view, (function (response) {
                          return TaskRunner$Guacamole.addTask(taskRunner, {
                                      TAG: 5,
                                      _0: response,
                                      [Symbol.for("name")]: "ViewResponse"
                                    });
                        })));
              return TaskRunner$Guacamole.addTask(taskRunner, {
                          TAG: 1,
  ...
  return Belt_Array.forEach(Command$Guacamole.names, (function (param) {
                ...
                disposables.push(registerCommand(param[1], (function (_editor, fileName) {
                            return Belt_Option.forEach(Registry$Guacamole.get(fileName), (function (param) {
                                          return TaskRunner$Guacamole.addTask(param[1], {
                                                      TAG: 1,
                                                      _0: command,
                                                      [Symbol.for("name")]: "DispatchCommand"
                                                    });
