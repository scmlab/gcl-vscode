...
function activate(context) {
  ...
  disposables.push(Vscode.window.onDidChangeActiveTextEditor((function (next) {
              if (Caml_obj.caml_notequal(Belt_Option.map(Belt_Option.map(next, (function (prim) {
                ...
                Belt_Option.forEach(Belt_Option.flatMap(previous.contents, Registry$Guacamole.getByEditor), (function (param) {
                        return State$Guacamole.hide(param[0]);
                      }));
                Belt_Option.forEach(Belt_Option.flatMap(next, Registry$Guacamole.getByEditor), (function (param) {
  ...
  disposables.push(registerCommand("toggle", (function (editor, fileName) {
              ...
              disposables.push(ViewController$Guacamole.recv(state.view, (function (response) {
