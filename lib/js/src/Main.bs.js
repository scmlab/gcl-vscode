...
function Impl$1(Editor, State) {
  ...
  var activate = function (context) {
    ...
    Curry._2(Editor.addToSubscriptions, Curry._1(Editor.onDidChangeActivation, (function (previous, next) {
                Belt_Option.forEach(Belt_Option.flatMap(previous, get), (function (state) {
                        Curry._1(State$2.hide, state);
                        console.log(Curry._1(Editor.getFileName, Curry._1(State$2.getEditor, state)), "[ deactivate ]");
                        return /* () */0;
                      }));
                return Belt_Option.forEach(Belt_Option.flatMap(next, get), (function (state) {
                              Curry._1(State$2.show, state);
                              console.log(Curry._1(Editor.getFileName, Curry._1(State$2.getEditor, state)), "[ activate ]");
                              return /* () */0;
                            }));
              })), context);
    ...
    return Curry._2(Editor.addToSubscriptions, Curry._2(Editor.registerCommand, "reload", (function (_editor) {
