...
var Resource$Guacamole = require("./Util/Resource.bs.js");
...
function toString$1(msg) {
  ...
  switch (msg.tag | 0) {
    ...
    case /* NotFound */1 :
        return /* tuple */[
                "Command not found",
                Util$Guacamole.JsError.toString(msg[0])
              ];
    case /* ShellError */2 :
        return /* tuple */[
...
function toString$2(error) {
  ...
  switch (error.tag | 0) {
    ...
    case /* ShellError */1 :
        return /* tuple */[
                "Socket error",
                Util$Guacamole.JsError.toString(error[0])
              ];
...
function make(path, args) {
  ...
  var disconnect = function (param) {
    ...
    var pending = Resource$Guacamole.make(undefined);
