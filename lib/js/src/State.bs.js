...
function Impl(Type, Editor) {
  var partial_arg = View$Guacamole.Impl;
  var View = (function (param) {
        return partial_arg(Type, param);
      })(Editor);
  ...
  var connect = function (state) {
    ...
    if (match !== undefined) {
      ...
      return $$Promise.tapOk($$Promise.mapError(Connection$Guacamole.make(Editor$1.getGCLPath, Editor$1.setGCLPath), (function (e) {
  ...
  var make = function (context, editor) {
    var view = Curry._2(View.make, context, editor);
    var state = {
      editor: editor,
      context: context,
  ...
  var destroy = function (state) {
    Curry._1(View.destroy, state.view);
