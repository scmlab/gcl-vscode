...
var Sig$Guacamole = require("./Editor/Sig.bs.js");
var Types$Guacamole = require("./Types.bs.js");
...
function Impl(Editor) {
  ...
  var sendRequest = function (state, request) {
    var value = Types$Guacamole.$$Request.encode(request);
    console.log("<<<", value);
  ...
  var make = function (context, editor) {
    ...
    Curry._3(Editor.View.recv, view, context, (function (param) {
            if (param.tag) {
              return /* () */0;
            } else {
              state.mode = param[0];
