...
function display(id, pos, props, warnings, warnings$prime) {
  return $$Promise.map(View$Guacamole.send({
                  TAG: 3,
                  _0: id,
                  _1: pos,
...
function handleResponseKind(state, kind) {
  switch (kind.TAG | 0) {
    case /* Error */0 :
        ...
        var errorToMessage = function (error) {
          ...
          if (typeof kind === "number") {
            return [[
                      "Lexical Error",
                      Curry._1(Response$Guacamole.$$Error.Site.toString, site)
                    ]];
          }
          switch (kind.TAG | 0) {
            ...
            case /* TypeError */2 :
                ...
                switch (name.TAG | 0) {
                  case /* NotInScope */0 :
                      return [[
                                "Not In Scope",
                                "The identifier \"" + name._0 + "\" " + Curry._1(Response$Guacamole.$$Error.Site.toString, site) + " is not in scope"
                              ]];
                  case /* UnifyFailed */1 :
                      return [[
                                "Cannot unify types",
                                "Cannot unify: " + Curry._1(GCL$Guacamole.Syntax.Type.toString, name._0) + "\nwith        : " + Curry._1(GCL$Guacamole.Syntax.Type.toString, name._1)
                              ]];
                  case /* RecursiveType */2 :
                      return [[
                                "Recursive type variable",
                                "Recursive type variable: " + name._0 + "\nin type             : " + Curry._1(GCL$Guacamole.Syntax.Type.toString, name._1)
                              ]];
                  case /* NotFunction */3 :
                      return [[
                                "Not a function",
                                "The type " + Curry._1(GCL$Guacamole.Syntax.Type.toString, name._0) + " is not a function type"
                              ]];
        ...
        var errorToSideEffects = function (error) {
          var kind = error._1;
          if (typeof kind === "number") {
            return $$Promise.resolved(undefined);
          }
          if (kind.TAG !== /* StructError */1) {
            return $$Promise.resolved(undefined);
          }
          if (kind._0 < 2) {
            return $$Promise.resolved(undefined);
          }
          var sites = Belt_Array.keepMap(errors, Response$Guacamole.$$Error.matchDigHole);
          var site = Belt_Array.get(sites, 0);
          if (site === undefined) {
            return $$Promise.resolved(undefined);
          }
        ...
        var errorMessages = Belt_Array.concatMany(Belt_Array.map(errors, errorToMessage));
        return $$Promise.flatMap(Util$Guacamole.$$Promise.oneByOne(Belt_Array.map(errors, errorToSideEffects)), (function (param) {
                      return displayErrorMessages(errorMessages);
                    }));
    case /* OK */1 :
        var warnings$prime = kind._5;
        var warnings = kind._4;
        var props = kind._3;
        var pos = kind._1;
        var i = kind._0;
        console.log(warnings$prime);
        redecorate(state, kind._2);
        return $$Promise.flatMap(displayErrorMessages([]), (function (param) {
                      return display(i, pos, props, warnings, warnings$prime);
                    }));
    case /* Inspect */2 :
        return updatePOs(kind._0);
    case /* Resolve */3 :
    ...
    case /* UpdateSpecPositions */5 :
        updateLocations(state, kind._0);
        return $$Promise.resolved(undefined);
    case /* ConsoleLog */6 :
        console.log(kind._0);
        return $$Promise.resolved(undefined);
