...
function make(extentionPath, editor) {
  ...
  var codeLensProvider_resolveCodeLens = function (lens, param) {
    console.log(lens);
    console.log("codeLensProvider.resolveCodeLens invoked");
    return Caml_option.some($$Promise.resolved(lens));
  };
  var codeLensProvider_provideCodeLenses = function (param, param$1) {
    ...
    var lenses = [
      ...
      new Vscode.CodeLens(new Vscode.Range(new Vscode.Position(0, 10), new Vscode.Position(0, 10)), {
            arguments: undefined,
            command: "guacamole.reload",
            title: "title 2",
            tooltip: "tooltip"
    ...
    return Caml_option.some($$Promise.resolved(lenses));
  };
  var codeLensProvider = {
