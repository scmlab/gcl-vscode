...
function Impl(Editor) {
  ...
  var make = function (context, editor) {
    ...
    return {
            ...
            onDestroyEventEmitter: Event$Guacamole.make(undefined)
          };
  };
  ...
  var fromCursorPosition = function (state) {
    ...
    Belt_Array.forEach(Belt_Array.keep(state.specifications, (function (spec) {
            ...
            if (spec$prime !== undefined && !Curry._2(Editor.$$Range.containsRange, Curry._1(Editor.$$Range.fromLoc, spec.loc), Curry._1(Editor.$$Range.fromLoc, spec$prime.loc))) {
              return ;
            } else {
