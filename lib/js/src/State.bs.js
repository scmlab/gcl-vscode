...
function handleResponseKind(state, kind) {
  switch (kind.TAG | 0) {
    case /* Error */0 :
        var errorToMessage = function (error) {
          switch (error.TAG | 0) {
            ...
            case /* TypeError */2 :
                ...
                switch (name.TAG | 0) {
                  case /* NotInScope */0 :
                      return [[
                                "Not In Scope",
                                "The identifier \"" + name._0 + "\" Response.Error.Site.toString(site) is not in scope"
                              ]];
                  case /* UnifyFailed */1 :
                      return [[
                                "Cannot unify types",
            ...
            case /* Others */4 :
                return [[
                          "Server Internal Error",
                          Element$Guacamole.Block.toString(error._0)
                        ]];
        ...
        return displayErrorMessages(Belt_Array.concatMany(Belt_Array.map(kind._0, errorToMessage)));
    case /* OK */1 :
