...
function sendRequest(state, request) {
  ...
  console.log("<<<", value);
  return $$Promise.mapError($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.Js.toResult(state.client.onReady()), (function (param) {
                ...
                return {
                        TAG: 0,
                        _0: Error$Guacamole.fromJsError(error),
                        [Symbol.for("name")]: "LSP"
                      };
              }));
}
