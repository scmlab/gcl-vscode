...
function make$2(devMode, viaTCP) {
  ...
  return $$Promise.map($$Promise.Js.toResult(self.client.onReady()), (function (result) {
                if (result.TAG !== /* Ok */0) {
                  return ;
                }
...
function start(devMode, viaTCP) {
  var match = singleton.contents;
  if (typeof match === "number" && match === 0) {
    singleton.contents = /* Connecting */1;
    Chan$Guacamole.emit(statusChan, /* Connecting */1);
    return $$Promise.map(make$2(devMode, viaTCP), (function (result) {
                  if (result !== undefined) {
                    singleton.contents = {
                      _0: Caml_option.valFromOption(result),
                      [Symbol.for("name")]: "Connected"
                    };
                    return Chan$Guacamole.emit(statusChan, /* Connected */2);
                  }
...
function sendRequest$1(request) {
  ...
  if (typeof client === "number") {
    ...
    return $$Promise.map(sendRequest(client._0, Request$Guacamole.encode(request)), (function (x) {
                  if (x.TAG === /* Ok */0) {
...
exports.onChangeConnectionStatus = onChangeConnectionStatus;
