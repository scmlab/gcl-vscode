...
function highlightBackground(editor, kind, range) {
  var backgroundColor = Vscode$Guacamole.ThemeColor.themeColor(kind ? new Vscode.ThemeColor("editor.wordHighlightStrongBackground") : new Vscode.ThemeColor("inputValidation.errorBackground"));
  var options = {
...
function overlayText(editor, kind, text, range) {
  var after = {
    color: Vscode$Guacamole.ThemeColor.themeColor(kind ? new Vscode.ThemeColor("descriptionForeground") : new Vscode.ThemeColor("errorForeground")),
    contentText: text
  };
  var options = {
    after: after
