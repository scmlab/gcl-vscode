...
function markBackground(editor, kind, range) {
  var backgroundColor = Vscode$Guacamole.ThemeColor.themeColor(kind ? new Vscode.ThemeColor("editor.findMatchBackground") : new Vscode.ThemeColor("inputValidation.errorBackground"));
  var options = {
