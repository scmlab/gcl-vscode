...
function downloadLanguageServer(context) {
  ...
  return $$Promise.tapOk($$Promise.tapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk(getReleasesFromGitHub(undefined), getMatchingRelease), getMatchingAsset), (function (param) {
                            var asset = param[1];
                            var release = param[0];
                        ...
                        zipFileStream.on("error", (function (exn) {
                                return Curry._1(resolve, {
                                            ...
                                            _0: {
                                              TAG: 6,
                                              _0: exn,
                                              [Symbol.for("name")]: "CannotUnzipFile"
                                            },
                                            [Symbol.for("name")]: "Error"
                                          });
                              }));
