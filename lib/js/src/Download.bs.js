...
function downloadLanguageServer(context) {
  ...
  return $$Promise.tap($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk(getReleasesFromGitHub(undefined), getMatchingRelease), getMatchingAsset), (function (param) {
                            var asset = param[1];
                            var release = param[0];
