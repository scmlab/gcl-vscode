      ...
      switch (x) {
        ...
        default:
          throw {
                ...
                _1: "[ConnectionStatus] Unknown constructor: " + x,
                Error: new Error()
              };
      }
    });
      ...
      switch (x) {
        ...
        case "ExportProofObligations" :
            return {
                    TAG: 1,
                    _0: (function (param) {
                        return /* ExportProofObligations */2;
                      }),
                    [Symbol.for("name")]: "TagOnly"
                  };
        case "Initialized" :
