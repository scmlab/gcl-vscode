                    ...
                    _0: (function (param) {
                        return Json_decode.map((function (param) {
                                      ...
                                      return Util$Guacamole.Decode.tuple5(Json_decode.$$int, (function (param) {
                                                    ...
                                                    return Json_decode.array(Response$Guacamole.Warning.decode, param);
                                                  }), (function (param) {
    ...
    case /* Display */3 :
        return Json_encode.object_({
                    ...
                    tl: {
                      hd: [
                        "contents",
                        Util$Guacamole.Encode.tuple5((function (prim) {
                                return prim;
                              }), (function (param) {
                                ...
                                return Json_encode.array(Response$Guacamole.Warning.encode, param);
                              }), (function (param) {
                                return Json_encode.array(Element$Guacamole.encode, param);
                              }), [
                              x._0,
                              x._1,
                              x._2,
    ...
    case /* UpdatePOs */4 :
        return Json_encode.object_({
                    ...
                    tl: {
                      hd: [
                        "contents",
                        Json_encode.array(Response$Guacamole.ProofObligation.encode, x._0)
                      ],
                      tl: /* [] */0
                    }
                  });
