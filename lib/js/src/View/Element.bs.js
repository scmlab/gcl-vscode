...
function Element$Block(Props) {
  ...
  var range = value._2;
  var headerClassNames = range !== undefined ? "gcl-list-item-header has-range" : "gcl-list-item-header";
  return React.createElement("li", {
              className: "gcl-list-item native-key-bindings",
              tabIndex: -1
            }, React.createElement("span", {
                  className: headerClassNames
                }, Belt_Option.mapWithDefault(value._1, "", (function (x) {
                        return x;
                      })), React.createElement("span", {
                      className: "gcl-list-item-range"
                    }, Belt_Option.mapWithDefault(range, "", GCL$Guacamole.$$Range.toString))), React.createElement("span", {
