              ...
              switch (x) {
                ...
                case "Link" :
                    ...
                    var partial_arg$5 = function (param) {
                      return Json_decode.tuple3(SrcLoc$Guabao.$$Range.decode, partial_arg$4, decode$1, param);
                    };
                    return {
                            TAG: /* Contents */0,
                            _0: (function (param) {
                ...
                case "Sbst" :
                    ...
                    var partial_arg$17 = function (param) {
                      return Json_decode.tuple4(partial_arg$16, partial_arg$14, partial_arg$12, decode$1, param);
                    };
                    return {
                            TAG: /* Contents */0,
                            _0: (function (param) {
                ...
                case "Sbst2" :
                    ...
                    var partial_arg$24 = function (param) {
                      return Util$Guabao.Decode.tuple5(decode, partial_arg$23, partial_arg$21, partial_arg$19, decode$1, param);
                    };
                    return {
                            TAG: /* Contents */0,
                            _0: (function (param) {
    ...
    case /* Sbst2 */4 :
        return Json_encode.object_({
                    ...
                    tl: {
                      hd: [
                        "contents",
                        Util$Guabao.Encode.tuple5(encode, (function (param) {
                                return Json_encode.array(encode$2, param);
                              }), (function (param) {
                                return Json_encode.array(encode$2, param);
                              }), (function (param) {
...
function Element$Inlines$Sbst(Props) {
  ...
  var env$1 = Curry._2(makeInline, /* Element */{
        _0: env
      }, history);
  return React.createElement("span", {
              className: "element-sbst"
...
function decode$7(json) {
  return {
          deco: Json_decode.field("sectionDeco", decode$6, json),
...
function encode$6(x) {
  return Json_encode.object_({
              ...
              tl: {
                hd: [
                  "sectionBlocks",
                  Json_encode.array(encode$4, x.blocks)
                ],
                tl: /* [] */0
              }
            });
