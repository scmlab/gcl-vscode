                      ...
                      return {
                              ...
                              _0: (function (param) {
                                  return Json_decode.map((function (param) {
                                                ...
                                                return Json_decode.tuple3(SrcLoc$Guabao.$$Range.decode, decode$3, decode$3, param);
                                              }), param);
                                })
                            };
                  default:
    ...
    case /* Spec */1 :
        return Json_encode.object_({
                    ...
                    tl: {
                      hd: [
                        "contents",
                        Json_encode.tuple3(SrcLoc$Guabao.$$Range.encode, encode$2, encode$2, [
                              x._0,
                              x._1,
                              x._2
                            ])
...
function Element$Block(Props) {
  ...
  switch (value.TAG | 0) {
    case /* Block */0 :
        ...
        var header = value._0;
        if (range !== undefined) {
          var header$1 = header !== undefined ? React.createElement(Link$Guabao.make, {
                  range: range,
    ...
    case /* Spec */1 :
        ...
        return React.createElement("li", {
                    className: "element-block"
                        ...
                        className: "element-block-header"
                      }, "precondition", React.createElement(Link$Guabao.make, {
                            range: range$1,
                            children: React.createElement("span", {
                                  className: "element-block-header-range"
                                }, SrcLoc$Guabao.$$Range.toString(range$1))
                          })), React.createElement("div", {
                        className: "element-block-body"
                      }, React.createElement("div", {
    ...
    case /* PO */2 :
        ...
        if (range$2 !== undefined) {
          var header$4 = header$3 !== undefined ? React.createElement(Link$Guabao.make, {
                  range: range$2,
                  children: React.createElement("div", {
                        className: "element-block-header"
                      }, header$3, React.createElement("span", {
                            className: "element-block-header-range"
                          }, SrcLoc$Guabao.$$Range.toString(range$2)))
                }) : React.createElement(React.Fragment, undefined);
          return React.createElement("li", {
                      className: "element-block"
