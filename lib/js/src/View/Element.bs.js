...
function block(header, range, deco, body) {
  return {
          TAG: /* Block */0,
          _0: header,
          _1: range,
...
function Element$Block(Props) {
  ...
  switch (value.TAG | 0) {
    case /* Block */0 :
        var range = value._1;
        var header = value._0;
        var header$1 = header !== undefined ? (
            range !== undefined ? React.createElement(Link$Guabao.make, {
                    range: range,
        ...
        var className = "element-block " + toClassName(value._2);
        return React.createElement("li", {
                    className: className
                  }, header$1, React.createElement("div", {
                        className: "element-block-body"
                      }, React.createElement("p", undefined, React.createElement(Element$Inlines, {
                                value: value._3
                              }))));
    case /* Spec */1 :
        var range$1 = value._0;
        return React.createElement("li", {
                    className: "element-block element-deco-blue"
                  }, React.createElement("div", {
                        className: "element-block-header"
                        ...
                        className: "element-block-body"
                      }, React.createElement("pre", undefined, React.createElement(Element$Inlines, {
                                value: value._1
                              }))), React.createElement("div", {
                        className: "element-block-header"
    ...
    case /* PO */2 :
        ...
        var header$2 = value._0;
        if (range$2 !== undefined) {
          var header$3 = header$2 !== undefined ? React.createElement(Link$Guabao.make, {
                  range: range$2,
                  children: React.createElement("div", {
                        className: "element-block-header"
                      }, header$2, React.createElement("span", {
                            className: "element-block-header-range"
        ...
        var header$4 = header$2 !== undefined ? React.createElement("div", {
                className: "element-block-header"
              }, header$2) : React.createElement(React.Fragment, undefined);
        return React.createElement("li", {
                    className: "element-block"
