...
function Element$Block(Props) {
  ...
  switch (value.TAG | 0) {
    ...
    case /* PO */1 :
        var header$1 = value._0;
        var header$2 = header$1 !== undefined ? React.createElement("div", {
                className: "element-block-header"
              }, header$1) : React.createElement(React.Fragment, undefined);
        return React.createElement("li", {
                    className: "element-block"
