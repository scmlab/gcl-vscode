...
function Body$GlobalProp(Props) {
  var payload = Props.payload;
  return React.createElement("li", {
              className: "gcl-body-item native-key-bindings",
              tabIndex: -1
...
function Body(Props) {
  ...
  if (body.TAG) {
    var paragraphs = Belt_Array.mapWithIndex(Belt_Array.keep(body._0.split("\n"), (function (x) {
                return x !== "";
              })), (function (i, s) {
  ...
  var globalProps = body._2;
  var pos = Belt_Array.mapWithIndex(body._1, (function (i, payload) {
          return React.createElement(Body$ProofObligation, {
                      payload: payload,
                      key: String(i)
                    });
        }));
  var globalPropHeader = globalProps.length !== 0 ? React.createElement("h2", undefined, "Global properties") : React.createElement(React.Fragment, undefined);
  var globalProps$1 = Belt_Array.mapWithIndex(globalProps, (function (i, payload) {
          return React.createElement(Body$GlobalProp, {
                      payload: payload,
                      key: String(i)
                    });
        }));
  return React.createElement(ReqID$Guacamole.Provider.make, ReqID$Guacamole.Provider.makeProps(body._0, React.createElement("div", {
                      className: "gcl-body"
                    }, React.createElement("ul", {
                          className: "gcl-proof-obligation-list"
                        }, pos), globalPropHeader, React.createElement("ul", {
                          className: "gcl-global-property-list"
                        }, globalProps$1)), undefined));
}
