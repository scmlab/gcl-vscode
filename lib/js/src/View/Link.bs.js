...
function Link(Props) {
  ...
  var onMouseOver = function (param) {
    return Curry._1(link.emit, /* MouseOver */Caml_chrome_debugger.variant("MouseOver", 0, [loc]));
  };
  var onMouseOut = function (param) {
    return Curry._1(link.emit, /* MouseOut */Caml_chrome_debugger.variant("MouseOut", 1, [loc]));
  };
  var onClick = function (param) {
    return Curry._1(link.emit, /* MouseClick */Caml_chrome_debugger.variant("MouseClick", 2, [loc]));
  };
