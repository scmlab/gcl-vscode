...
function Panel(Props) {
  ...
  var warningMessagesBlock = warnings.length === 0 ? React.createElement(React.Fragment, undefined) : React.createElement("div", {
          className: "gcl-global-props"
        }, React.createElement("h2", undefined, "Warnings"), React.createElement("ul", {
              className: "gcl-global-property-list"
            }, Belt_Array.mapWithIndex(match$2[4], (function (i, value) {
                    return React.createElement(Element$Guacamole.make, {
                                value: value,
                                key: String(i)
                              });
                  }))), React.createElement("ul", {
              className: "gcl-global-property-list"
            }, Belt_Array.mapWithIndex(warnings, (function (i, warning) {
                    if (warning.TAG === /* MissingBound */0) {
                      return React.createElement(Common$Guacamole.Item.make, {
  ...
  return React.createElement(Subst$Guacamole.Provider.make, Subst$Guacamole.Provider.makeProps(onSubstitute.current, React.createElement(Link$Guacamole.Provider.make, Link$Guacamole.Provider.makeProps(onClickLink.current, React.createElement("section", {
                              ...
                              tabIndex: -1
                                  ...
                                  method: match[0]
                                }), errorMessagesBlock, warningMessagesBlock, React.createElement(ProofObligations$Guacamole.make, {
                                  id: id,
                                  pos: match$2[1],
                                  onExport: onExport
