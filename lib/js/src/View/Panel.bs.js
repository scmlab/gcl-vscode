...
function Panel(Props) {
  ...
  var setConnectViaTCP = match$1[1];
  var connectViaTCP = match$1[0];
  ...
  React.useEffect((function () {
          Chan$Guacamole.emit(onResponse, /* Initialized */2);
          ...
          return Chan$Guacamole.on(onRequest, (function (req) {
                        switch (req.TAG | 0) {
                          case /* UpdateDevMode */0 :
                              var devMode = req._0;
                              Curry._1(setDevMode, (function (param) {
                                      return devMode;
                                    }));
                              return Curry._1(setConnectViaTCP, (function (param) {
                                            return devMode;
                                          }));
  ...
  React.useEffect((function () {
          return Chan$Guacamole.on(onDisconnect.current, (function (param) {
                        return Chan$Guacamole.emit(onResponse, /* Disconnect */0);
                      }));
        }), []);
  React.useEffect((function () {
          return Chan$Guacamole.on(onConnect.current, (function (viaTCP) {
                        return Chan$Guacamole.emit(onResponse, {
                                    TAG: 0,
                                    _0: viaTCP,
                                    [Symbol.for("name")]: "Connect"
                                  });
                      }));
        }), []);
  React.useEffect((function () {
          return Chan$Guacamole.on(onChangeConnectionMethod.current, (function (viaTCP) {
                        return Chan$Guacamole.emit(onResponse, {
                                    TAG: 0,
                                    _0: viaTCP,
                                    [Symbol.for("name")]: "Connect"
  ...
  var onChangeMethod = function (param) {
    Curry._1(setConnectViaTCP, (function (value) {
            return !value;
          }));
    return Chan$Guacamole.emit(onChangeConnectionMethod.current, !connectViaTCP);
  };
  var onConnect$1 = function (param) {
    return Chan$Guacamole.emit(onConnect.current, connectViaTCP);
  };
  var onDisconnect$1 = function (param) {
    return Chan$Guacamole.emit(onDisconnect.current, undefined);
  };
  var onExport = function (param) {
    return Chan$Guacamole.emit(onResponse, /* ExportProofObligations */1);
  };
