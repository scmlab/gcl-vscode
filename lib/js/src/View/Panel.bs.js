...
function Panel(Props) {
  ...
  var onReduce = React.useRef(Event$Guacamole.make(/* () */0));
  ...
  React.useEffect((function () {
          return Curry._1(onReduce.current.on, (function (param) {
                        return Curry._1(onResponse.emit, /* Reduce */Caml_chrome_debugger.variant("Reduce", 2, [
                                      param[0],
                                      param[1]
                                    ]));
                      }));
  ...
  return React.createElement(Subst$Guacamole.Provider.make, Subst$Guacamole.Provider.makeProps(onReduce.current, React.createElement(Link$Guacamole.Provider.make, Link$Guacamole.Provider.makeProps(onClickLink.current, React.createElement("section", {
                              className: className,
                              tabIndex: -1
