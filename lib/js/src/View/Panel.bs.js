...
function Panel(Props) {
  ...
  var onClickLink = React.useRef(Event$AgdaModeVscode.make(undefined));
  var onSubstitute = React.useRef(Event$AgdaModeVscode.make(undefined));
  ...
  return React.createElement(Subst2$Guacamole.Provider.make, Subst2$Guacamole.Provider.makeProps(onSubstitute.current, React.createElement(Subst$Guacamole.Provider.make, Subst$Guacamole.Provider.makeProps(onSubstitute.current, React.createElement(Link$Guacamole.Provider.make, Link$Guacamole.Provider.makeProps(onClickLink.current, React.createElement("section", {
                                      className: className,
                                      tabIndex: -1
