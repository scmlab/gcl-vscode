...
function Panel(Props) {
  ...
  React.useEffect((function () {
          return Chan$Guabao.on(onRequest, (function (req) {
                        if (req.TAG === /* UpdateConnectionStatus */0) {
                          var status = req._0;
  ...
  return React.createElement(Link$Guabao.Provider.make, Link$Guabao.Provider.makeProps(onClickLink.current, React.createElement(Substitution$Guabao.Provider.make, Substitution$Guabao.Provider.makeProps(onSubst, React.createElement(ReqID$Guabao.Provider.make, ReqID$Guabao.Provider.makeProps(match$2[0], React.createElement("section", {
