  ...
  switch (value.TAG | 0) {
    ...
    case /* HeaderWithAnchor */1 :
        ...
        if (range$1 === undefined) {
          return React.createElement("header", undefined, header$1);
        }
        var anchor = value._2;
        var hash = value._1;
        var header$2 = anchor !== undefined ? header$1 + " #" + hash + " anchored at " + SrcLoc$Guabao.$$Range.toString(anchor) : header$1 + " #" + hash;
        return React.createElement(Link$Guabao.make, {
                    range: range$1,
                    children: React.createElement("header", undefined, header$2, React.createElement("span", {
                              className: "element-block-header-range"
