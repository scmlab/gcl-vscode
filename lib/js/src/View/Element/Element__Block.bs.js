...
function Element__Block$Code(Props) {
  ...
  var trace = Trace$Guabao.make(undefined);
  var match = React.useState(function () {
        return true;
      });
  var setHidden = match[1];
  var stepBack = function (param) {
    return Trace$Guabao.pop(trace);
  };
  ...
  return React.createElement(Trace$Guabao.Context.Provider.make, {
              value: trace,
              children: null
                      ...
                      value: value
                    })), React.createElement(Trace$Guabao.View.make, {
                  hidden: match[0]
                }));
}
