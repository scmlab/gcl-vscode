...
function Element__Block$Code(Props) {
  ...
  var onClick = function (param) {
    History$Guabao.pop(history);
    return Curry._1(setHidden, (function (prim) {
                  return !prim;
                }));
  };
  return React.createElement(History$Guabao.Context.Provider.make, {
              value: history,
              children: null
            }, React.createElement("pre", undefined, React.createElement("div", {
                      ...
                      value: value
                    })), React.createElement(History$Guabao.View.make, {
                  hidden: match[0]
                }));
}
