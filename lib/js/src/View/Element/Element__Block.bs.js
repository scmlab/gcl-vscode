...
function Element__Block(Props) {
  ...
  var onDisplayExplanation = Props.onDisplayExplanation;
  var match = React.useState(function () {
        return false;
      });
  var setHeaderClicked = match[1];
  var headerClicked = match[0];
  switch (value.TAG | 0) {
    case /* Header */0 :
        var range = value._1;
        var header = value._0;
    ...
    case /* HeaderWithButtons */1 :
        ...
        var onClickHeader = function (param) {
          Curry._1(onDisplayExplanation, !headerClicked);
          return Curry._1(setHeaderClicked, (function (x) {
                        return !x;
                      }));
        };
        var className = headerClicked ? "element-block-header-text toggled" : "element-block-header-text";
        var onClickSolveButton$1 = function (param) {
          return Curry._1(onClickSolveButton, hash);
        };
        var solveBotton = React.createElement("button", {
              className: "element-block-header-solve-button",
              onClick: onClickSolveButton$1
            }, React.createElement("span", {
                  className: "codicon codicon-wand"
                }), React.createElement("span", {
                  className: "element-block-header-solve-button-label"
                }, "solve"));
        var header$1 = React.createElement(React.Fragment, undefined, React.createElement("span", {
                  className: className,
                  onClick: onClickHeader
                }, value._0), range$2, solveBotton);
        ...
        return React.createElement("header", undefined, header$1, anchor$1);
    case /* Paragraph */2 :
