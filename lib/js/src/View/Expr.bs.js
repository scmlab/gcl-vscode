      ...
      switch (param.tag | 0) {
        ...
        case /* Quant */7 :
            return /* Complete */Caml_chrome_debugger.variant("Complete", 1, [React.createElement(Link$Guacamole.make, {
                            loc: param[4],
                            children: null
                          }, "<", React.createElement(Expr$Space, { }), React.createElement(make, makeProps(-1, param[0], undefined, /* () */0)), React.createElement(Expr$Space, { }), Util$Guacamole.React.sepBy(React.createElement(Expr$Space, { }), $$Array.map((function (value) {
        ...
        case /* Subst */8 :
            var e = Belt_Array.map(Js_dict.entries(param[1]), (function (param) {
                    return React.createElement(React.Fragment, undefined, React.createElement(make, makeProps(0, param[1], undefined, /* () */0)), "/" + param[0]);
                  }));
            return /* Complete */Caml_chrome_debugger.variant("Complete", 1, [React.createElement(Link$Guacamole.make, {
                            loc: /* NoLoc */0,
                            children: null
                          }, React.createElement(make, makeProps(0, param[0], undefined, /* () */0)), "[", Util$Guacamole.React.sepBy(", ", e), "]")]);
        case /* Unknown */9 :
            return /* Complete */Caml_chrome_debugger.variant("Complete", 1, [React.createElement(Link$Guacamole.make, {
                            loc: /* NoLoc */0,
