...
function Expr$Low(Props) {
  ...
  return React.createElement("div", undefined, Curry._1(GCL$Guacamole.Syntax.Lower.toString, value));
}
      ...
      switch (param.tag | 0) {
        case /* Var */0 :
            return /* Complete */Caml_chrome_debugger.variant("Complete", 1, [React.createElement(Link$Guacamole.make, {
                            loc: param[1],
                            children: Curry._1(GCL$Guacamole.Syntax.Lower.toString, param[0])
                          })]);
        case /* Const */1 :
            return /* Complete */Caml_chrome_debugger.variant("Complete", 1, [React.createElement(Link$Guacamole.make, {
                            loc: param[1],
                            children: Curry._1(GCL$Guacamole.Syntax.Upper.toString, param[0])
                          })]);
        case /* Lit */2 :
            return /* Complete */Caml_chrome_debugger.variant("Complete", 1, [React.createElement(Link$Guacamole.make, {
                            loc: param[1],
        ...
        case /* Quant */5 :
            return /* Complete */Caml_chrome_debugger.variant("Complete", 1, [React.createElement(Link$Guacamole.make, {
                            loc: param[4],
                            children: null
                          }, "<", React.createElement(Expr$Space, { }), React.createElement(make, makeProps(0, param[0], undefined, /* () */0)), React.createElement(Expr$Space, { }), Util$Guacamole.React.sepBy(React.createElement(Expr$Space, { }), $$Array.map((function (value) {
