...
function Subst(Props) {
  ...
  var tmp;
  tmp = typeof redux === "number" || redux.TAG === /* Unreduced */0 ? "" : " reduced";
  var className = "expr-subst" + ((
      match$1[0] ? " hovered" : ""
    ) + tmp);
  reqID.current = React.useContext(ReqID$Guacamole.context);
  if (typeof redux !== "number" && redux.TAG !== /* Unreduced */0) {
  ...
  React.useEffect((function () {
          return Chan$Guacamole.on(channel, (function (x) {
                        if (x.TAG === /* Request */0) {
                          return ;
                        }
                        if (!Caml_obj.caml_equal(x._0, id.current)) {
                          return ;
                        }
                        var expr = x._1;
  ...
  switch (expr$1.TAG | 0) {
    ...
    case /* Subst */8 :
        ...
        var expressions = Belt_Array.map(subst$1, (function (param) {
                return React.createElement(makePrec, Curry._3(makePrecProps, 0, param[1], undefined));
              }));
        var variables = Belt_Array.map(subst$1, (function (param) {
                return React.createElement(React.Fragment, undefined, Curry._1(GCL$Guacamole.Syntax.Name.toString, param[0]));
              }));
        return React.createElement(Link$Guacamole.make, {
                    loc: /* NoLoc */0,
                    children: null
