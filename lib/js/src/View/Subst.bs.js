...
function Subst(Props) {
  ...
  if (typeof redux !== "number" && redux.tag && Caml_obj.caml_notequal(redux[0], reqID.current)) {
  ...
  if (typeof redux === "number") {
    ...
    return React.createElement(makeExpr, Curry._3(makeExprProps, 0, redux[1], /* () */0));
  } else {
    ...
    return React.createElement(React.Fragment, undefined, React.createElement(makeExpr, Curry._3(makeExprProps, 0, redux[0], /* () */0)), React.createElement(Common$Guacamole.Space.make, { }), React.createElement("div", {
                    className: className,
                    onClick: onClick,
