...
function Subst(Props) {
  ...
  return React.createElement(React.Fragment, undefined, React.createElement(makePrec, Curry._3(makePrecProps, 0, redux[0], undefined)), React.createElement(Common$Guacamole.Space.make, { }), React.createElement("div", {
                  className: className,
                  onClick: onClick,
