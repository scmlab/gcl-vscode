...
function Pred$Marker(Props) {
  ...
  var sort = Props.sort;
  var text = Props.text;
  var locOpt = Props.loc;
  var children = Props.children;
  var loc = locOpt !== undefined ? locOpt : /* NoLoc */0;
  ...
  return React.createElement("div", {
              className: "marker" + (sort$1 + kind$1)
                ...
                }, children), React.createElement(Link$Guacamole.make, {
                  loc: loc,
                  children: null
                }, React.createElement("div", {
  ...
  switch (value.tag | 0) {
    case /* Constant */0 :
        return React.createElement(Pred$Marker, {
                    children: React.createElement(Expr$Guacamole.make, {
                          value: value[0]
                        })
                  });
    case /* Bound */1 :
    ...
    case /* Conjunct */6 :
        return Util$Guacamole.React.sepBy(" ∧ ", $$Array.map((function (x) {
