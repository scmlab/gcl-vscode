...
function toVSCodeRange(x) {
  var end_ = x._1;
  return new Vscode.Range(toVSCodePos(x._0), new Vscode.Position(end_.line - 1 | 0, end_.column));
}
...
function toString$1(range) {
  ...
  if (start.line === end_.line) {
    return String(start.line) + ":" + String(start.column) + "-" + String(end_.column);
  } else {
    return String(start.line) + ":" + String(start.column) + "-" + String(end_.line) + ":" + String(end_.column);
  }
}
