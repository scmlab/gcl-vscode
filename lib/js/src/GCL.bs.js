...
var decode$1 = Util$Guacamole.Decode.sum(function (x) {
      ...
      throw {
            ...
            _1: "[Range] Unknown constructor: " + x,
            Error: new Error()
          };
    });
...
function decode$5(param) {
  return Json_decode.map((function (param) {
                ...
                return Json_decode.pair(Json_decode.string, decode$2, param);
              }), param);
}
...
function disjunct$prime(x) {
  ...
  var x$1 = x.hd;
  if (xs) {
    return disj(x$1, disjunct$prime(xs));
  } else {
    return x$1;
  }
}

function conjunct$prime(x) {
  if (!x) {
    return {
            TAG: 0,
            _0: {
  ...
  var x$1 = x.hd;
  if (xs) {
    return conj(x$1, conjunct$prime(xs));
  } else {
    return x$1;
  }
}
                      ...
                      return {
                              ...
                              _0: (function (param) {
                                  return Json_decode.map((function (param) {
                                                ...
                                                return Json_decode.tuple3(decode$6, decode$6, decode$2, param);
                                              }), param);
                                }),
                              [Symbol.for("name")]: "Contents"
                            };
                      ...
                      return {
                              ...
                              _0: (function (param) {
                                  return Json_decode.map((function (param) {
                                                ...
                                                return Json_decode.pair(decode$5, decode$2, param);
                                              }), param);
                                }),
                              [Symbol.for("name")]: "Contents"
                            };
                      ...
                      return {
                              ...
                              _0: (function (param) {
                                  return Json_decode.map((function (param) {
                                                ...
                                                return Json_decode.tuple3(decode$5, decode$6, decode$2, param);
                                              }), param);
                                }),
                              [Symbol.for("name")]: "Contents"
                            };
                      ...
                      return {
                              ...
                              _0: (function (param) {
                                  return Json_decode.map((function (param) {
                                                ...
                                                return Json_decode.pair(decode$4, decode$2, param);
                                              }), param);
                                }),
                              [Symbol.for("name")]: "Contents"
                            };
                              ...
                              _0: (function (param) {
                                  return Json_decode.map((function (param) {
                                                ...
                                                return Util$Guacamole.Decode.tuple5(decode$6, (function (param) {
                                                            ...
                                                            }), decode$6, decode$6, decode$2, param);
                                              }), param);
                                }),
                              [Symbol.for("name")]: "Contents"
                            };
                      ...
                      return {
                              ...
                              _0: (function (param) {
                                  return Json_decode.map((function (param) {
                                                ...
                                                return Json_decode.pair(decode$6, (function (param) {
                                                              return Json_decode.array((function (param) {
                                                                            return Json_decode.pair(decode$5, decode$6, param);
                                                                          }), param);
                                                            }), param);
                                              }), param);
                                }),
    ...
    case /* Lit */0 :
        return Json_encode.object_({
                    ...
                    tl: {
                      hd: [
                        "contents",
                        Json_encode.pair(encode$3, encode$2, [
                              x._0,
                              x._1
                            ])
                      ],
    ...
    case /* Var */1 :
        return Json_encode.object_({
                    ...
                    tl: {
                      hd: [
                        "contents",
                        Json_encode.pair(encode$5, encode$2, [
                              x._0,
                              x._1
                            ])
                      ],
    ...
    case /* Op */3 :
        return Json_encode.object_({
                    ...
                    tl: {
                      hd: [
                        "contents",
                        Json_encode.pair(encode$4, encode$2, [
                              x._0,
                              x._1
                            ])
                      ],
    ...
    case /* App */4 :
        return Json_encode.object_({
                    ...
                    tl: {
                      hd: [
                        "contents",
                        Json_encode.tuple3(encode$6, encode$6, encode$2, [
                              x._0,
                              x._1,
                              x._2
                            ])
    ...
    case /* Lam */5 :
        return Json_encode.object_({
                    ...
                    tl: {
                      hd: [
                        "contents",
                        Json_encode.tuple3(encode$5, encode$6, encode$2, [
                              x._0,
                              x._1,
                              x._2
                            ])
    ...
    case /* Subst */8 :
        return Json_encode.object_({
                    ...
                    tl: {
                      hd: [
                        "contents",
                        Json_encode.pair(encode$6, (function (param) {
                                return Json_encode.array((function (param) {
                                              return Json_encode.pair(encode$5, encode$6, param);
                                            }), param);
                              }), [
                              x._0,
                              x._1
  ...
  switch (m.TAG | 0) {
    case /* InfixL */0 :
        ...
        return flatMap($$var, (function (p) {
                      return flatMap($$var, (function (q) {
                                    return {
                                            TAG: 1,
                                            _0: parensIf(n > m$1, toString$6(m$1, p) + (" " + (toString$4(op) + (" " + toString$6(m$1 + 1 | 0, q))))),
                                            [Symbol.for("name")]: "Complete"
                                          };
                                  }));
                    }));
    case /* InfixR */1 :
        ...
        return flatMap($$var, (function (p) {
                      return flatMap($$var, (function (q) {
                                    return {
                                            TAG: 1,
                                            _0: parensIf(n > m$2, toString$6(m$2 + 1 | 0, p) + (" " + (toString$4(op) + (" " + toString$6(m$2, q))))),
                                            [Symbol.for("name")]: "Complete"
                                          };
                                  }));
                    }));
    case /* Infix */2 :
        ...
        return flatMap($$var, (function (p) {
                      return flatMap($$var, (function (q) {
                                    return {
                                            TAG: 1,
                                            _0: parensIf(n > m$3, toString$6(m$3 + 1 | 0, p) + (" " + (toString$4(op) + (" " + toString$6(m$3 + 1 | 0, q))))),
                                            [Symbol.for("name")]: "Complete"
                                          };
                                  }));
                    }));
    case /* Prefix */3 :
        ...
        return flatMap($$var, (function (p) {
                      return {
                              TAG: 1,
                              _0: parensIf(n > m$4, toString$4(op) + (" " + toString$6(m$4, p))),
                              [Symbol.for("name")]: "Complete"
                            };
                    }));
    case /* Postfix */4 :
        ...
        return flatMap($$var, (function (p) {
                      return {
                              TAG: 1,
                              _0: parensIf(n > m$5, toString$6(m$5, p) + (" " + toString$4(op))),
                              [Symbol.for("name")]: "Complete"
                            };
                    }));
  ...
  while(true) {
    ...
    switch (x.TAG | 0) {
      ...
      case /* Lam */5 :
          return {
                  TAG: 1,
                  _0: "\\" + (toString$5(x._0) + (" -> " + toString$6(0, x._1))),
                  [Symbol.for("name")]: "Complete"
                };
      case /* Hole */6 :
          return {
      ...
      case /* Quant */7 :
          return {
                  TAG: 1,
                  _0: "< " + (toString$6(0, x._0) + (" " + (Caml_splice_call.spliceObjApply(" ", "concat", [Belt_Array.map(x._1, toString$5)]) + (" : " + (toString$6(0, x._2) + (" : " + (toString$6(0, x._3) + " >"))))))),
                  [Symbol.for("name")]: "Complete"
                };
      case /* Subst */8 :
          _x = x._0;
                      ...
                      return {
                              ...
                              _0: (function (param) {
                                  return Json_decode.map((function (param) {
                                                ...
                                                return Json_decode.pair(decode$6, decode$2, param);
                                              }), param);
                                }),
                              [Symbol.for("name")]: "Contents"
                            };
    ...
    case /* Bound */1 :
        return Json_encode.object_({
                    ...
                    tl: {
                      hd: [
                        "contents",
                        Json_encode.pair(encode$6, encode$2, [
                              x._0,
                              x._1
                            ])
                      ],
    ...
    case /* Conjunct */6 :
        return Json_encode.object_({
                    ...
                    tl: {
                      hd: [
                        "contents",
                        Json_encode.array(encode$7, x._0)
                      ],
                      tl: /* [] */0
                    }
                  });
...
function toExpr(x) {
  switch (x.TAG | 0) {
    case /* Conjunct */6 :
        var xs = Belt_Array.map(x._0, toExpr);
        return conjunct$prime(Belt_List.fromArray(xs));
    case /* Disjunct */7 :
        var xs$1 = Belt_Array.map(x._0, toExpr);
        return disjunct$prime(Belt_List.fromArray(xs$1));
    case /* Negate */8 :
        return negate(toExpr(x._0));
    default:
      return x._0;
  }
}
...
function toString$10(x) {
  if (x.TAG === /* Including */0) {
    return "Including " + toString$6(0, x._0);
  } else {
    return "Excluding " + toString$6(0, x._0);
  }
}
...
var decode$9 = Util$Guacamole.Decode.sum(function (x) {
      switch (x) {
        ...
        default:
          throw {
                RE_EXN_ID: Json_decode.DecodeError,
                _1: "[GCL.Syntax.Type.Endpoint] Unknown constructor: " + x,
                Error: new Error()
              };
      }
    });
...
function toString$11(x) {
  return "Interval " + toString$10(x._0) + " " + toString$10(x._1);
}
...
function decode$10(param) {
  return Json_decode.map((function (param) {
                return {
                        ...
                        _1: param[1],
                        _2: param[2],
                        [Symbol.for("name")]: "Interval"
                      };
              }), (function (param) {
                return Json_decode.tuple3(decode$9, decode$9, decode$2, param);
              }), param);
}
...
function toString$12(x) {
  switch (x.TAG | 0) {
    ...
    case /* Array */1 :
        return "Array " + toString$11(x._0) + " " + toString$12(x._1);
    case /* Func */2 :
        return toString$12(x._0) + (" -> " + toString$12(x._1));
    case /* Var */3 :
        return "Var " + toString$5(x._0);
  ...
  return Util$Guacamole.Decode.sum(function (x) {
                switch (x) {
                      ...
                      return {
                              ...
                              _0: (function (param) {
                                  return Json_decode.map((function (param) {
                                                ...
                                                return Json_decode.tuple3(decode$10, decode$11, decode$2, param);
                                              }), param);
                                }),
                              [Symbol.for("name")]: "Contents"
                            };
                      ...
                      return {
                              ...
                              _0: (function (param) {
                                  return Json_decode.map((function (param) {
                                                ...
                                                return Json_decode.pair(decode$8, decode$2, param);
                                              }), param);
                                }),
                              [Symbol.for("name")]: "Contents"
                            };
                      ...
                      return {
                              ...
                              _0: (function (param) {
                                  return Json_decode.map((function (param) {
                                                ...
                                                return Json_decode.tuple3(decode$11, decode$11, decode$2, param);
                                              }), param);
                                }),
                              [Symbol.for("name")]: "Contents"
                            };
                  ...
                  default:
                    throw {
                          RE_EXN_ID: Json_decode.DecodeError,
                          _1: "[GCL.Syntax.Type] Unknown constructor: " + x,
                          Error: new Error()
                        };
                }
              })(json);
