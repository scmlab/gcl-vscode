...
var decode$16 = Util$Guacamole.Decode.sum((function (tag) {
        switch (tag) {
          case "DigHole" :
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                            return /* DigHole */5;
...
var decodeKind = Util$Guacamole.Decode.sum((function (tag) {
        switch (tag) {
          ...
          case "StructError2" :
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (json) {
                            return /* StructError2 */Caml_chrome_debugger.variant("StructError2", 2, [Curry._1(decode$16, json)]);
                          })]);
          case "SyntacticError" :
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
          ...
          case "TypeError" :
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (json) {
                            return /* TypeError */Caml_chrome_debugger.variant("TypeError", 3, [Curry._1(decode$14, json)]);
                          })]);
          default:
            throw [
                  Json_decode.DecodeError,
...
var decode$18 = Util$Guacamole.Decode.sum((function (tag) {
        switch (tag) {
          case "Error" :
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                            return Json_decode.map((function (errors) {
                                          ...
                                          return Json_decode.array(decode$17, param);
                                        }), param);
                          })]);
          case "Insert" :
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
