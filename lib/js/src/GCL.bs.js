                      ...
                      return {
                              ...
                              _0: (function (param) {
                                  return Json_decode.map((function (param) {
                                                ...
                                                return Json_decode.tuple3(Json_decode.string, decode$6, decode$2, param);
                                              }), param);
                                }),
                              [Symbol.for("name")]: "Contents"
                            };
                      ...
                      return {
                              ...
                              _0: (function (param) {
                                  return Json_decode.map((function (param) {
                                                ...
                                                return Json_decode.pair(decode$6, decodeSubst, param);
                                              }), param);
                                }),
                              [Symbol.for("name")]: "Contents"
                            };
    ...
    case /* Subst */8 :
        return Json_encode.object_({
                    ...
                    tl: {
                      hd: [
                        "contents",
                        Json_encode.pair(encode$6, encodeSubst, [
                              x._0,
                              x._1
                            ])
                      ],
...
function encodeSubst(json) {
  return Json_encode.dict(encode$6, json);
}
