    ...
    case /* Conjunct */6 :
        return Json_encode.object_({
                    ...
                    tl: {
                      hd: [
                        "contents",
                        Json_encode.array(encode$6, x._0)
                      ],
                      tl: /* [] */0
                    }
                  });
...
function toString$9(x) {
  if (x.TAG === /* Including */0) {
    return "Including " + toString$5(0, x._0);
  } else {
    return "Excluding " + toString$5(0, x._0);
  }
}
...
function toString$10(x) {
  return "Interval " + toString$9(x._0) + " " + toString$9(x._1);
}
...
function decode$9(param) {
  return Json_decode.map((function (param) {
                ...
                return Json_decode.tuple3(decode$8, decode$8, decode$1, param);
              }), param);
}
...
function toString$11(x) {
  switch (x.TAG | 0) {
    ...
    case /* Array */1 :
        return "Array " + toString$10(x._0) + " " + toString$11(x._1);
    case /* Func */2 :
        return toString$11(x._0) + (" -> " + toString$11(x._1));
    case /* Var */3 :
        return "Var " + toString$4(x._0);
                      ...
                      return {
                              ...
                              _0: (function (param) {
                                  return Json_decode.map((function (param) {
                                                ...
                                                return Json_decode.tuple3(decode$9, decode$10, decode$1, param);
                                              }), param);
                                }),
                              [Symbol.for("name")]: "Contents"
                            };
                      ...
                      return {
                              ...
                              _0: (function (param) {
                                  return Json_decode.map((function (param) {
                                                ...
                                                return Json_decode.pair(decode$7, decode$1, param);
                                              }), param);
                                }),
                              [Symbol.for("name")]: "Contents"
                            };
                      ...
                      return {
                              ...
                              _0: (function (param) {
                                  return Json_decode.map((function (param) {
                                                ...
                                                return Json_decode.tuple3(decode$10, decode$10, decode$1, param);
                                              }), param);
                                }),
                              [Symbol.for("name")]: "Contents"
                            };
