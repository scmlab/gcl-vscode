...
var VSCode$AgdaModeVscode = require("agda-mode-vscode/lib/js/src/VSCode.bs.js");
...
function make$3(param, param$1) {
  return ViewController$Guacamole.make(getExtensionPath, param, param$1);
}
...
function highlightBackground(editor, kind, range) {
  ...
  var backgroundColor = VSCode$AgdaModeVscode.ThemeColor.themeColor(tmp);
  var options = {
...
function overlayText(editor, kind, text, range) {
  ...
  var after = {
    color: VSCode$AgdaModeVscode.ThemeColor.themeColor(tmp),
    contentText: text
  };
  var options = {
    after: after
