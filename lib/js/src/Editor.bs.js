...
var View__Controller$Guacamole = require("./View__Controller.bs.js");
...
function make$3(param, param$1) {
  return View__Controller$Guacamole.make(getExtensionPath, param, param$1);
}

var View = {
  send: View__Controller$Guacamole.send,
  recv: View__Controller$Guacamole.recv,
  destroy: View__Controller$Guacamole.destroy,
  show: View__Controller$Guacamole.show,
  hide: View__Controller$Guacamole.hide,
  make: make$3
};
