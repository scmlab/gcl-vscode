      ...
      switch (x) {
        case "ExcessBound" :
            return {
                    TAG: 0,
                    _0: (function (param) {
                        return Json_decode.map((function (loc) {
                                      return {
                                              TAG: 1,
                                              _0: loc,
                                              [Symbol.for("name")]: "ExcessBound"
                                            };
                                    }), GCL$Guacamole.Loc.decode, param);
                      }),
                    [Symbol.for("name")]: "Contents"
        ...
        default:
          throw {
                RE_EXN_ID: Json_decode.DecodeError,
                _1: "[Response.Warning] Unknown constructor: " + x,
                Error: new Error()
              };
      }
    });
            ...
            return {
                    ...
                    _0: (function (param) {
                        return Json_decode.map((function (param) {
                                      ...
                                      return Util$Guacamole.Decode.tuple6(Json_decode.$$int, (function (param) {
                                                    return Json_decode.array(decode$1, param);
                                                  }), (function (param) {
                                                    ...
                                                    return Json_decode.array(Element$Guacamole.decode, param);
                                                  }), param);
                                    }), param);
                      }),
                    [Symbol.for("name")]: "Contents"
...
var decode$10 = Util$Guacamole.Decode.sum(function (x) {
      switch (x) {
                    ...
                    _0: (function (param) {
                        return Json_decode.map((function (param) {
                                      ...
                                      return Json_decode.pair(Json_decode.string, (function (param) {
                                                    return Json_decode.array(decode$9, param);
                                                  }), param);
                                    }), param);
                      }),
                    [Symbol.for("name")]: "Contents"
